import type { EcosystemNode } from "../services/ecosystem-feed.ts";
 ...
 */
export function hubTooltipHtml(node: EcosystemNode, opts: { isSelf: boolean; archived: boolean }): string {
